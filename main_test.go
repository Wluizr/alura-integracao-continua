...
// Utilize o comando go test -v mian_test.go ; Para que possa obter o resultado de forma mais verbosa.
...
func TestVerificaStatusCodeDaSaudacaoComParametro(t *testing.T) {
	...
	mockDaResposta := `{"API diz":"alterando para ocasionar um erro"}`
